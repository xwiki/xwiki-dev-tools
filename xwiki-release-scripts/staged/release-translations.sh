...
function do_all() {
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.TourHomepageTourTranslations&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.MainWebHome&app=Platform'
    ...
    if [[ -f "${XWIKI_TRUNKS}/xwiki-platform/xwiki-platform-core/xwiki-platform-wysiwyg/xwiki-platform-wysiwyg-client/pom.xml" ]]; then
      ...
      do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Wysiwyg.Stringsproperties&app=Wysiwyg'
      ...
      do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Wysiwyg.WidgetResources&app=Wysiwyg'

      cd ${XWIKI_TRUNKS}/xwiki-platform/xwiki-platform-core/xwiki-platform-wysiwyg/xwiki-platform-wysiwyg-client/src/main/resources/org/xwiki/gwt/wysiwyg/client/  || exit -1
      do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Wysiwyg.WYSIWYGEditorCoreParametrizedResources&app=Wysiwyg'
    fi
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiTemplateProviderTranslations&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiCoreResources&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.Repository&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.AnnotationCodeTranslations&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.SandboxWebHome&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.PlatformSandboxTestPage&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.MainSolrTranslations&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiXWikiSyntaxTranslations&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiXWikiSyntaxDefinitionLists&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiXWikiSyntaxEscapes&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiXWikiSyntaxGeneralRemarks&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiXWikiSyntaxGroups&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiXWikiSyntaxHeadings&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiXWikiSyntaxHorizontalLine&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiXWikiSyntaxHTML&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiXWikiSyntaxImages&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiXWikiSyntaxIntroduction&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiXWikiSyntaxLinks&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiXWikiSyntaxLists&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiXWikiSyntaxMacros&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiXWikiSyntaxNewLineLineBreaks&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiXWikiSyntaxOtherSyntaxes&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiXWikiSyntaxParagraphs&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiXWikiSyntaxParameters&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiXWikiSyntaxQuotations&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiXWikiSyntaxScripts&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiXWikiSyntaxTables&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiXWikiSyntaxTextFormatting&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiXWikiSyntaxVerbatim&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.HelpTranslations&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.HelpSupportPanelContent&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.WikiManagerTranslations&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.WikiWikiManagerTranslations&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.CommonWikiManagerCommonTranslations&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.xwiki-platform-wiki-default&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.PanelsTranslations&app=Platform'
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.PanelsCodeTranslations&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.SkinExtensions&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.xwiki-platform-extension-handler-xar&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.LocalizationMacro&app=Platform'

    ## Mail
    cd ${XWIKI_TRUNKS}/xwiki-platform/xwiki-platform-core/xwiki-platform-mail/xwiki-platform-mail-ui/src/main/resources/ || exit -1
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.MailTranslations&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.IndexTranslations&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiDocumentTreeTranslations&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.MacrosTreeTranslations&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiWatchListTranslations&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.IconThemesCodeTranslations&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.MenuApplication&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.InvitationTranslations&app=Platform'
    ...
    if [[ -f "${XWIKI_TRUNKS}/xwiki-platform/xwiki-platform-core/xwiki-platform-flamingo/xwiki-platform-flamingo-themes/xwiki-platform-flamingo-theme-ui/pom.xml" ]]; then
      ...
      do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.FlamingoThemesCodeTranslations&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.MainActivityTranslations&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiUserDirectoryTranslations&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiUserProfileTranslations&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.Ratingmodule&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiRatingsTranslations&app=Platform'
    ...
    if [[ -f "${XWIKI_TRUNKS}/xwiki-platform/xwiki-platform-core/xwiki-platform-template/pom.xml" ]]; then
        ...
        do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.TemplateMacro&app=Platform'
    fi
    ...
    if [[ -f "${XWIKI_TRUNKS}/xwiki-platform/xwiki-platform-core/xwiki-platform-skin/xwiki-platform-skin-ui/pom.xml" ]]; then
        ...
        do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.SkinsCodeTranslations&app=Platform'
    ...
    if [[ -f "${XWIKI_TRUNKS}/xwiki-platform/xwiki-platform-tools/xwiki-platform-tool-jetty/xwiki-platform-tool-jetty-listener/pom.xml" ]]; then
        ...
        do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.Jettylistener&app=Platform'
    fi
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiOfficeImporterTranslations&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.AppWithinMinutesTranslations&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.ApplicationsTranslations&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.DashboardTranslations&app=Platform'
    ...
    cd ${XWIKI_TRUNKS}/xwiki-platform/xwiki-platform-core/xwiki-platform-administration/xwiki-platform-administration-ui/src/main/resources/ || exit -1
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Platform.XWikiAdminTranslationsxml&app=Platform'
    cd ${XWIKI_TRUNKS}/xwiki-platform/xwiki-platform-core/xwiki-platform-administration/xwiki-platform-administration-ui && format_xar
    ...
    if [[ -f "${XWIKI_TRUNKS}/xwiki-platform/xwiki-platform-core/xwiki-platform-notifications/xwiki-platform-notifications-ui/pom.xml" ]]; then
      ...
      do_one 'http://l10n-old.xwiki.org/xwiki/bin/view/L10NCode/GetTranslationFile?name=Platform.XWikiNotificationsCodeTranslations&app=Platform'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Rendering.ContentMacro&app=Rendering'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Commons.xwiki-commons-job&app=Commons'
    ...
    do_one 'http://l10n-old.xwiki.org/xwiki/bin/get/L10NCode/GetTranslationFile?name=Commons.xwiki-commons-extension-api&app=Commons'
